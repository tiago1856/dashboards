import { Div, Hx, Button, Img } from '../builders/BuildingBlocks.js';
...
export class AreYouSureModal extends Div { 
    ...
    constructor(ok_callback=null, cancel_callback=null) {
        ...
        modal_title.setTextContent('CONFIRMAR!');
