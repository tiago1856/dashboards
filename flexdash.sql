...
-- Dumping data for table flexdash.dash_component: ~4 rows (approximately)
...
-- Dumping data for table flexdash.dash_config: ~4 rows (approximately)
...
INSERT INTO `dash_dashboard` (`id`, `name`, `description`, `title`, `date_created`, `date_updated`, `data`, `author`, `updated_by`, `layout`, `date_format`) VALUES
	...
	(24, '9c493001-ab31-4a0b-ab2e-f2510f7aa7e4', '', NULL, '2022-01-28 14:09:46.118512', '2022-04-01 13:49:52.557844', '{"0": {"id": null, "name": "3b4929d7-75b4-4cfd-b9a5-70c273148cc0", "description": "error?", "title": "", "component_type": "INFO", "query": {"query_selection": "13", "query": "SELECT \\n\\tCOUNT(*) AS Count, (SELECT COUNT(*) FROM world.country) AS Total\\nFROM\\n\\tworld.country\\nWHERE \\n\\tcountry.SurfaceArea > 1000000", "query_selected_fields": ["Count"], "query_fields": ["Count"]}, "visualization": {"visualization_type": "ISL", "visualization_tab": "data-visualization-info"}, "data_config": {"value": "Count", "text_1": "Count", "text_2": "", "icon": "icon ion-md-alert", "fields": []}, "uuid": "c8deaeb6-c3e0-46ba-ace5-9fd74dd9a85e"}, "1": {"id": null, "name": null, "description": null, "title": null, "component_type": null, "query": {"query_selection": null, "query": null, "query_selected_fields": null, "query_fields": null}, "visualization": {"visualization_type": null, "visualization_tab": null}, "data_config": {}, "uuid": "6d24fd5c-7a74-46da-9069-38d94f638f0b"}}', 1, 1, 2, NULL),
	...
	(29, '999', '', NULL, '2022-03-07 13:44:50.800943', '2022-04-20 11:09:56.931031', '{"components": {"0": {"id": null, "name": "1810290b-8136-4c5c-83c4-8099e016e3c7", "description": "", "title": "zzzzzzzzzzzzzz", "component_type": "TABLE", "query": {"query_selection": "2", "query": "SELECT * FROM world.country WHERE SurfaceArea > 1000000", "query_selected_fields": ["Code", "Name", "Continent", "Region", "SurfaceArea", "IndepYear", "Population", "LifeExpectancy", "GNP", "GNPOld", "LocalName", "GovernmentForm", "HeadOfState", "Capital", "Code2"], "query_fields": ["Code", "Name", "Continent", "Region", "SurfaceArea", "IndepYear", "Population", "LifeExpectancy", "GNP", "GNPOld", "LocalName", "GovernmentForm", "HeadOfState", "Capital", "Code2"]}, "visualization": {"visualization_type": "TS", "visualization_tab": "data-visualization-tables"}, "data_config": {"fields": ["Code", "Name", "Continent", "Region", "SurfaceArea", "IndepYear", "Population", "LifeExpectancy", "GNP", "GNPOld", "LocalName", "GovernmentForm", "HeadOfState", "Capital", "Code2"]}, "uuid": "9643dea7-bbc0-4ada-a3ef-f253d4d0b64b", "options": {"sizes-height-component": "550", "header-background-color": "#0000ff", "header-color": "#ffffff", "header-alignment": "start", "header-vertical-alignment": "bottom", "rows-background-color": "rgba(0, 0, 0, 0)", "rows-color": "rgb(33, 37, 41)", "rows-alignment": "end", "rows-vertical-alignment": "top"}}, "1": {"id": null, "name": "3843185f-1047-4587-9927-2650ec5e13f4", "description": "", "title": "", "component_type": "GRAPH", "query": {"query_selection": "12", "query": "SELECT * FROM world.country WHERE country.SurfaceArea > 5000000", "query_selected_fields": ["Code", "Name", "Continent", "Region", "SurfaceArea", "IndepYear", "Population", "LifeExpectancy", "GNP", "GNPOld", "LocalName", "GovernmentForm", "HeadOfState", "Capital", "Code2"], "query_fields": ["Code", "Name", "Continent", "Region", "SurfaceArea", "IndepYear", "Population", "LifeExpectancy", "GNP", "GNPOld", "LocalName", "GovernmentForm", "HeadOfState", "Capital", "Code2"]}, "visualization": {"visualization_type": "G1N", "visualization_tab": "data-visualization-graphs"}, "data_config": {"fields": ["Code", "SurfaceArea"]}, "uuid": "de2eccac-2f48-4507-ac76-8800e48d93df", "options": null}}, "comms": {"io": {"de2eccac-2f48-4507-ac76-8800e48d93df": {"inputs": ["country.SurfaceArea"], "outputs": [], "name": "3843185f-1047-4587-9927-2650ec5e13f4", "indices": {"inputs": ["7d073736-cee4-4177-8dd8-927ce4bd3d44", "7d073736-cee4-4177-8dd8-927ce4bd3d44", "7d073736-cee4-4177-8dd8-927ce4bd3d44", "7d073736-cee4-4177-8dd8-927ce4bd3d44", "7d073736-cee4-4177-8dd8-927ce4bd3d44", "7d073736-cee4-4177-8dd8-927ce4bd3d44", "7d073736-cee4-4177-8dd8-927ce4bd3d44", "7d073736-cee4-4177-8dd8-927ce4bd3d44"], "outputs": []}}, "9643dea7-bbc0-4ada-a3ef-f253d4d0b64b": {"inputs": ["SurfaceArea"], "outputs": ["Code", "Name", "Continent", "Region", "SurfaceArea", "IndepYear", "Population", "LifeExpectancy", "GNP", "GNPOld", "LocalName", "GovernmentForm", "HeadOfState", "Capital", "Code2"], "name": "1810290b-8136-4c5c-83c4-8099e016e3c7", "indices": {"inputs": ["2c8329fe-9e51-427b-8767-e343186ae032", "2c8329fe-9e51-427b-8767-e343186ae032", "2c8329fe-9e51-427b-8767-e343186ae032", "2c8329fe-9e51-427b-8767-e343186ae032", "2c8329fe-9e51-427b-8767-e343186ae032", "2c8329fe-9e51-427b-8767-e343186ae032", "2c8329fe-9e51-427b-8767-e343186ae032", "2c8329fe-9e51-427b-8767-e343186ae032"], "outputs": ["23c77a43-ccbc-4327-8392-94d4855271d4", "205e2526-61eb-46ad-9fc0-f2e0a6f8cdbd", "044aad66-6b16-4276-99fc-6539d14b0e69", "3fcb1941-f752-4e5d-aed6-a5dcffe02883", "e0b69e41-9773-4f11-99be-ee44a9b8ced4", "a0f4e39b-6b75-460b-8e72-216a2dd7977a", "ea6d8656-5061-43ca-8604-07880d2eea8a", "23fe81d3-3e6e-4b6f-ad25-12fbfff77b47", "441c8a77-6b38-459e-af7a-782391bbb2dd", "5542f3d4-9820-4961-b167-aaf87aaa2237", "273e4110-bcaa-4578-984e-2768f3e9e023", "dd17321a-b473-46a8-ab60-2076213c5faf", "98a8ae8c-ca88-4433-bc98-ac1a32690d6e", "718dcb1f-fab1-4389-a311-d8c910474479", "57086334-bdfc-4cbb-8caa-e33fe1c59d33", "23c77a43-ccbc-4327-8392-94d4855271d4", "205e2526-61eb-46ad-9fc0-f2e0a6f8cdbd", "044aad66-6b16-4276-99fc-6539d14b0e69", "3fcb1941-f752-4e5d-aed6-a5dcffe02883", "e0b69e41-9773-4f11-99be-ee44a9b8ced4", "a0f4e39b-6b75-460b-8e72-216a2dd7977a", "ea6d8656-5061-43ca-8604-07880d2eea8a", "23fe81d3-3e6e-4b6f-ad25-12fbfff77b47", "441c8a77-6b38-459e-af7a-782391bbb2dd", "5542f3d4-9820-4961-b167-aaf87aaa2237", "273e4110-bcaa-4578-984e-2768f3e9e023", "dd17321a-b473-46a8-ab60-2076213c5faf", "98a8ae8c-ca88-4433-bc98-ac1a32690d6e", "718dcb1f-fab1-4389-a311-d8c910474479", "57086334-bdfc-4cbb-8caa-e33fe1c59d33", "23c77a43-ccbc-4327-8392-94d4855271d4", "205e2526-61eb-46ad-9fc0-f2e0a6f8cdbd", "044aad66-6b16-4276-99fc-6539d14b0e69", "3fcb1941-f752-4e5d-aed6-a5dcffe02883", "e0b69e41-9773-4f11-99be-ee44a9b8ced4", "a0f4e39b-6b75-460b-8e72-216a2dd7977a", "ea6d8656-5061-43ca-8604-07880d2eea8a", "23fe81d3-3e6e-4b6f-ad25-12fbfff77b47", "441c8a77-6b38-459e-af7a-782391bbb2dd", "5542f3d4-9820-4961-b167-aaf87aaa2237", "273e4110-bcaa-4578-984e-2768f3e9e023", "dd17321a-b473-46a8-ab60-2076213c5faf", "98a8ae8c-ca88-4433-bc98-ac1a32690d6e", "718dcb1f-fab1-4389-a311-d8c910474479", "57086334-bdfc-4cbb-8caa-e33fe1c59d33", "23c77a43-ccbc-4327-8392-94d4855271d4", "205e2526-61eb-46ad-9fc0-f2e0a6f8cdbd", "044aad66-6b16-4276-99fc-6539d14b0e69", "3fcb1941-f752-4e5d-aed6-a5dcffe02883", "e0b69e41-9773-4f11-99be-ee44a9b8ced4", "a0f4e39b-6b75-460b-8e72-216a2dd7977a", "ea6d8656-5061-43ca-8604-07880d2eea8a", "23fe81d3-3e6e-4b6f-ad25-12fbfff77b47", "441c8a77-6b38-459e-af7a-782391bbb2dd", "5542f3d4-9820-4961-b167-aaf87aaa2237", "273e4110-bcaa-4578-984e-2768f3e9e023", "dd17321a-b473-46a8-ab60-2076213c5faf", "98a8ae8c-ca88-4433-bc98-ac1a32690d6e", "718dcb1f-fab1-4389-a311-d8c910474479", "57086334-bdfc-4cbb-8caa-e33fe1c59d33", "23c77a43-ccbc-4327-8392-94d4855271d4", "205e2526-61eb-46ad-9fc0-f2e0a6f8cdbd", "044aad66-6b16-4276-99fc-6539d14b0e69", "3fcb1941-f752-4e5d-aed6-a5dcffe02883", "e0b69e41-9773-4f11-99be-ee44a9b8ced4", "a0f4e39b-6b75-460b-8e72-216a2dd7977a", "ea6d8656-5061-43ca-8604-07880d2eea8a", "23fe81d3-3e6e-4b6f-ad25-12fbfff77b47", "441c8a77-6b38-459e-af7a-782391bbb2dd", "5542f3d4-9820-4961-b167-aaf87aaa2237", "273e4110-bcaa-4578-984e-2768f3e9e023", "dd17321a-b473-46a8-ab60-2076213c5faf", "98a8ae8c-ca88-4433-bc98-ac1a32690d6e", "718dcb1f-fab1-4389-a311-d8c910474479", "57086334-bdfc-4cbb-8caa-e33fe1c59d33", "23c77a43-ccbc-4327-8392-94d4855271d4", "205e2526-61eb-46ad-9fc0-f2e0a6f8cdbd", "044aad66-6b16-4276-99fc-6539d14b0e69", "3fcb1941-f752-4e5d-aed6-a5dcffe02883", "e0b69e41-9773-4f11-99be-ee44a9b8ced4", "a0f4e39b-6b75-460b-8e72-216a2dd7977a", "ea6d8656-5061-43ca-8604-07880d2eea8a", "23fe81d3-3e6e-4b6f-ad25-12fbfff77b47", "441c8a77-6b38-459e-af7a-782391bbb2dd", "5542f3d4-9820-4961-b167-aaf87aaa2237", "273e4110-bcaa-4578-984e-2768f3e9e023", "dd17321a-b473-46a8-ab60-2076213c5faf", "98a8ae8c-ca88-4433-bc98-ac1a32690d6e", "718dcb1f-fab1-4389-a311-d8c910474479", "57086334-bdfc-4cbb-8caa-e33fe1c59d33", "23c77a43-ccbc-4327-8392-94d4855271d4", "205e2526-61eb-46ad-9fc0-f2e0a6f8cdbd", "044aad66-6b16-4276-99fc-6539d14b0e69", "3fcb1941-f752-4e5d-aed6-a5dcffe02883", "e0b69e41-9773-4f11-99be-ee44a9b8ced4", "a0f4e39b-6b75-460b-8e72-216a2dd7977a", "ea6d8656-5061-43ca-8604-07880d2eea8a", "23fe81d3-3e6e-4b6f-ad25-12fbfff77b47", "441c8a77-6b38-459e-af7a-782391bbb2dd", "5542f3d4-9820-4961-b167-aaf87aaa2237", "273e4110-bcaa-4578-984e-2768f3e9e023", "dd17321a-b473-46a8-ab60-2076213c5faf", "98a8ae8c-ca88-4433-bc98-ac1a32690d6e", "718dcb1f-fab1-4389-a311-d8c910474479", "57086334-bdfc-4cbb-8caa-e33fe1c59d33", "23c77a43-ccbc-4327-8392-94d4855271d4", "205e2526-61eb-46ad-9fc0-f2e0a6f8cdbd", "044aad66-6b16-4276-99fc-6539d14b0e69", "3fcb1941-f752-4e5d-aed6-a5dcffe02883", "e0b69e41-9773-4f11-99be-ee44a9b8ced4", "a0f4e39b-6b75-460b-8e72-216a2dd7977a", "ea6d8656-5061-43ca-8604-07880d2eea8a", "23fe81d3-3e6e-4b6f-ad25-12fbfff77b47", "441c8a77-6b38-459e-af7a-782391bbb2dd", "5542f3d4-9820-4961-b167-aaf87aaa2237", "273e4110-bcaa-4578-984e-2768f3e9e023", "dd17321a-b473-46a8-ab60-2076213c5faf", "98a8ae8c-ca88-4433-bc98-ac1a32690d6e", "718dcb1f-fab1-4389-a311-d8c910474479", "57086334-bdfc-4cbb-8caa-e33fe1c59d33"]}}}, "links": {"con_52": {"source": {"component": "9643dea7-bbc0-4ada-a3ef-f253d4d0b64b", "pin": "SurfaceArea", "index": 4}, "target": {"component": "de2eccac-2f48-4507-ac76-8800e48d93df", "pin": "country.SurfaceArea", "index": 0}}}, "in_diagram": {"9643dea7-bbc0-4ada-a3ef-f253d4d0b64b": {"top": -185.667, "left": 201.5}, "de2eccac-2f48-4507-ac76-8800e48d93df": {"top": 150, "left": 683.3}}}}', NULL, 1, 2, NULL),
	(31, '1bc87b65-91ff-4e3d-b9a9-a9da71cf6ee6', '', NULL, '2022-03-14 08:01:39.266698', '2022-03-14 08:09:50.792318', '{"0": {"id": null, "uuid": "bea0f761-cfec-4197-89d0-acf51d262e43", "name": "d2f22360-7ac0-4cae-99d6-bccbd46302a2", "description": "", "title": "", "component_type": "GRAPH", "query": {"query_selection": "2", "query": "SELECT * FROM world.country WHERE SurfaceArea > 1000000", "query_selected_fields": [], "query_fields": []}, "visualization": {"visualization_type": "G1N", "visualization_tab": "data-visualization-graphs"}, "data_config": {"fields": ["Code", "SurfaceArea"]}}, "1": {"id": null, "uuid": "4c0f23ac-b3a0-4692-8dca-db3b05a56be0", "name": null, "description": null, "title": null, "component_type": null, "query": {"query_selection": null, "query": null, "query_selected_fields": null, "query_fields": null}, "visualization": {"visualization_type": null, "visualization_tab": null}, "data_config": {}}}', NULL, NULL, 2, NULL),
...
INSERT INTO `user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `first_name`, `last_name`, `email`, `is_staff`, `is_active`, `date_joined`) VALUES
	(1, 'pbkdf2_sha256$216000$gUQNPHOWH1ov$DcBDWzLl1NUzNwxGR8ZTLgXZGxXPVduJM1I5BogE74U=', '2022-04-19 10:38:46.145417', 1, 'admin', '', '', 'admin@admin.com', 1, 1, '2021-10-14 16:22:53.040080');
