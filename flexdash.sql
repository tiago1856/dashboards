...
INSERT INTO `dash_config` (`id`, `name`, `date`, `author`, `dashboard`) VALUES
	...
	(5, 'ea2c3191-11cb-4e64-ade4-3936aa81c8cd', '2022-03-14 08:14:45.939265', NULL, 32),
...
INSERT INTO `dash_dashboard` (`id`, `name`, `description`, `title`, `date_created`, `date_updated`, `data`, `author`, `updated_by`, `layout`, `date_format`) VALUES
	...
	(29, '7ef64baa-03cf-4952-9cea-28d261fbe85d', '', NULL, '2022-03-07 13:44:50.800943', '2022-04-03 11:04:15.590678', '{"0": {"id": null, "name": "1810290b-8136-4c5c-83c4-8099e016e3c7", "description": "", "title": "xxxx", "component_type": "TABLE", "query": {"query_selection": "2", "query": "SELECT * FROM world.country WHERE SurfaceArea > 1000000", "query_selected_fields": ["Code", "Name", "Continent", "Region", "SurfaceArea", "IndepYear", "Population", "LifeExpectancy", "GNP", "GNPOld", "LocalName", "GovernmentForm", "HeadOfState", "Capital", "Code2"], "query_fields": ["Code", "Name", "Continent", "Region", "SurfaceArea", "IndepYear", "Population", "LifeExpectancy", "GNP", "GNPOld", "LocalName", "GovernmentForm", "HeadOfState", "Capital", "Code2"]}, "visualization": {"visualization_type": "TS", "visualization_tab": "data-visualization-tables"}, "data_config": {"fields": ["Code", "Name", "Continent", "Region", "SurfaceArea", "IndepYear", "Population", "LifeExpectancy", "GNP", "GNPOld", "LocalName", "GovernmentForm", "HeadOfState", "Capital", "Code2"]}, "uuid": "9643dea7-bbc0-4ada-a3ef-f253d4d0b64b"}, "1": {"id": null, "name": "3843185f-1047-4587-9927-2650ec5e13f4", "description": "", "title": "", "component_type": "GRAPH", "query": {"query_selection": "12", "query": "SELECT continent,\\tCOUNT(*) as total FROM world.country GROUP BY continent;", "query_selected_fields": [], "query_fields": []}, "visualization": {"visualization_type": "G1N", "visualization_tab": "data-visualization-graphs"}, "data_config": {"fields": ["continent", "total"]}, "uuid": "de2eccac-2f48-4507-ac76-8800e48d93df"}}', NULL, 1, 2, NULL),
	...
	(32, '1111', '', NULL, '2022-03-14 08:14:40.322169', '2022-03-14 08:14:40.322169', '{"0": {"id": null, "uuid": "a0cc9411-5164-4874-b746-3968fa6dd650", "name": "c5632e1d-3dbb-4d55-b7aa-87bcdf7af9e7", "description": "", "title": "", "component_type": "GRAPH", "query": {"query_selection": "2", "query": "SELECT * FROM world.country WHERE SurfaceArea > 1000000", "query_selected_fields": ["Code"], "query_fields": []}, "visualization": {"visualization_type": "G1N", "visualization_tab": "data-visualization-graphs"}, "data_config": {"fields": ["Code", "SurfaceArea"]}}, "1": {"id": null, "uuid": "5dfb7d5e-a65f-403d-abad-f1e5efbd0bb3", "name": null, "description": null, "title": null, "component_type": null, "query": {"query_selection": null, "query": null, "query_selected_fields": null, "query_fields": null}, "visualization": {"visualization_type": null, "visualization_tab": null}, "data_config": {}}}', NULL, NULL, 2, NULL);
...
INSERT INTO `user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `first_name`, `last_name`, `email`, `is_staff`, `is_active`, `date_joined`) VALUES
	(1, 'pbkdf2_sha256$216000$gUQNPHOWH1ov$DcBDWzLl1NUzNwxGR8ZTLgXZGxXPVduJM1I5BogE74U=', '2022-03-28 12:20:06.899057', 1, 'admin', '', '', 'admin@admin.com', 1, 1, '2021-10-14 16:22:53.040080');
