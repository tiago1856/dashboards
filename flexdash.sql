...
-- Dumping data for table flexdash.dash_config: ~24 rows (approximately)
...
-- Dumping data for table flexdash.django_admin_log: ~123 rows (approximately)
